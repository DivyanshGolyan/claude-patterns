...
extract-claude-messages = "claude_patterns.extraction:main"
cluster-claude-messages = "claude_patterns.clustering:main"
generate-claude-commands = "claude_patterns.generation:cli_main"
```
